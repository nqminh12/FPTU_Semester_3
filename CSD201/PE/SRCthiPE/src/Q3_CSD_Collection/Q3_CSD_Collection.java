...
public class Q3_CSD_Collection {
    ...
    D) but display 5 vertices from the 3nd vertex to the 7th vertex only. Hint: copy breadth(...)
    to breadth2(...) and modify the latter one. Content of the output file f1.tx( must be:
    D A G B C E H I F
    G B C E H
    */
