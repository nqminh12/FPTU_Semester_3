...
void deleteRightChildByCopying(Node p) { // copy right
...
//      deleByCopy(p);
    ...
    /*
        Suppose p is the 4-th node when performing the in-order traversal. Calculate
    number of nodes in the sub-tree with root p and suppose this number is k, then 
    set p.info.type = k
    */
...
/*
    Suppose p is the 3-th node when performing the in-order traversal of the tree.
If p has right son then rotate p to left 
*/
